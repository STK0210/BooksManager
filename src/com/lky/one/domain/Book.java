...
@ManagedBean(name = "book", eager = false)
@SessionScoped
public class Book implements Serializable {
	...
	public Book(String bname, String bnum, String[] authers, Date pubDate, float price, int kind, int bid,
...
//		return null;
	...
	public String toString() {
		return "Book [bname=" + bname + ", bnum=" + bnum + ", authers=" + Arrays.toString(authers) + ", pubDate="
				+ pubDate + ", price=" + price + ", kind=" + kind + ", bid=" + bid + ", subKind=" + subKind + "]";
	}
